...
$(document).ready(() => {
    v = new Viewer("https://hundredthree.github.io/HT-JavaScript-Python/chino");
});
    ...
    constructor(basePath) {
        ...
        this.app.view.addEventListener('mousemove', (event) => {
            if (this.model) {
                ...
                this.model.pointerX = -mouse_x / (this.app.view.height * 5); // 减慢 2 倍
                this.model.pointerY = -mouse_y / (this.app.view.width * 5);  // 减慢 2 倍
            }
        });
